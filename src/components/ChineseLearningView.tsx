        ...
        {parsedItems.map((item, idx) => {
          ...
          return (
            <div
              ...
              className={`flex flex-col gap-2 rounded-2xl border p-5 transition-all shadow-2xs cursor-pointer select-none ${
                isPlaying
                  ? "border-red-600 bg-red-600/[0.04] ring-2 ring-red-600/30 shadow-xs"
