...
export const STRINGS = {
  ko: {
    ...
    "player.speed": "속도",
    "player.back5": "5초 뒤로",
    "player.missingAudio": "오디오 파일이 없어 합성 음성으로 재생합니다.",
    "player.fullLesson": "전체 강의",
    "player.clip": "클립",
    "player.listen": "듣기",
    "player.ttsMode": "합성 재생",
  ...
  en: {
    ...
    "player.missingAudio": "Audio file unavailable; playing with synthesized speech.",
    "player.fullLesson": "Full lesson",
    "player.clip": "Clip",
    "player.listen": "Listen",
    "player.ttsMode": "Synthesized",
  ...
  ja: {
    ...
    "player.speed": "速度",
    "player.back5": "5秒戻る",
    "player.missingAudio": "音声ファイルがないため、合成音声で再生します。",
  ...
  zh: {
    ...
    "player.speed": "速度",
    "player.back5": "后退5秒",
    "player.missingAudio": "音频不可用，正在使用合成语音朗读。",
