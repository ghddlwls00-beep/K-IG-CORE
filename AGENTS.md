...
**[`docs/qa-2026-09-18/지금-할-일.md`](docs/qa-2026-09-18/지금-할-일.md) 가 현재 작업 지시의 입구입니다** (2026-09-23 부터).
단계 순서와 각 단계의 명령서·작업기록이 거기 있습니다. 이 파일은 "어떻게" 에 해당합니다.
`docs/qa-2026-09-15/NEXT-SESSION.md` 는 지난 세션들의 기록입니다 — 지금 지시가 아닙니다.
같은 저장소에서 다른 AI 가 함께 일합니다. 각 단계 작업기록을 먼저 보고, 이미 된 일을 다시 하지 마세요.
...
(`StudentLearningView.tsx` 755 · 841 · 1183 의 🔈 → `toggleSentence(ko, …, "ko")`). STUDENT 의
한국어를 바꾸면 그 줄의 클립도 새로 만들어야 합니다.
...
`지금-할-일.md` 가 가리키는 현재 단계 명령서에 적힌 일은 묻지 말고 진행하세요. 다만 **되돌리기 어려운 일**
