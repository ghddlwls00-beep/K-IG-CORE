...
K-IG 교육의 핵심 과정을 웹에서 학습할 수 있도록 구축한 독립 플랫폼입니다.

> GVA 영어독해 직강은 2026-09-15에 사이트에서 제외되었습니다. 코드·콘텐츠·R2 자산이 모두
> 제거되었으며, 복원이 필요하면 커밋 `ead6a01`(restore GVA reading lectures with R2 streaming)
> 이전 이력을 참고하세요. 원본 강의 파일은 리포에 없습니다.
