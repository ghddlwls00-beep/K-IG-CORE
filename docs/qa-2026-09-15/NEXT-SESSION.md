...
## 0-Z. 🔴 지금 작업 대기열 — 새 세션은 여기부터 (2026-09-17 00:50 기준)

> 이 절이 현재 작업 지시입니다. 아래 §0-A·§A·§B 는 지난 세션들의 기록입니다.
> **`main` 은 `fa80c93` (RE-006 정정) 까지 배포되어 있습니다.** 반쯤 된 변경은 없습니다.
...
두 가지 순서로 했고 모두 0건이었습니다. **아이폰 실기기는 확인하지 않았습니다.**
