...
> **✅ 수정 상태 (2026-09-17, 로컬 수정·검증, 배포 대기):** S-01~S-33 **전부** 반영 — `scripts/apply-student.cjs` (65레슨 219곳) + `scripts/apply-student-followup.cjs` (검사가 찾은 3곳: s10-1 청크, s3-2·s4-5 청크 영어 속 한글 예시 이름). 사실: 광복 1945·해방, 휴전 뒤에도 분단 유지, 신라 이후 고려·조선 약 1,000년·일제 1910–1945, 한글 1443 창제·1446 반포(세종 친제), 이순신 제독·400여 년 전·개량 거북선·물리침, 광복절·어린이날·설날·추석, 토요 수업 없음, 2002 한일 공동 개최·첫 승 2002, 엘리자베스 2세 1999, 한국민속촌 용인, 불국사·속리산·독립기념관. 문법·어휘·표기·로마자(Silla·Gojoseon·Chuseok·Gyeongju·songpyeon·hanbok·Dangun·TV)·한국어 맞춤법. **S-05** s19-3 영어 4문장 복원(+지시문·청크), 잔재 삭제. **S-06/S-07** 다른 판 청크를 쓰던 17개 레슨 + 문장이 바뀐 레슨의 청크를 그 레슨 문장에서 새로 작성. **S-30** 목록 밖 개요 페이지 s1–s5 는 삭제하지 않고 `content/archive/student-overview/` 로 옮겨 더는 서비스되지 않음(학생 경로 87→82). 괄호 빈칸 규칙 유지(예시 이름 대신 `(이름)`). **검증:** `scripts/verify-student-fixes.cjs` **44/44** — 서비스되는 82개 레슨 전부: 청크 카드 **1,050/1,050** 이 자기 레슨 문장 안에 있음(수정 전 17개 레슨 0~31%), 영어 속 한글 0, 영어 문장 수 = 한국어 문단 수, 감사가 적은 틀린 형태 전부 없음, 사실 문장 확인. 음성 752개 (버킷 45,741, pending 0), 무료 음성 목록 갱신(s1-2), `verify-speech-gate-rules` 13/13.
