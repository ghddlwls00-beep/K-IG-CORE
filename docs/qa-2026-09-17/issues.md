...
- **L-64 처리 (2026-09-17, 소유자 결정):** 회차별 대본 대조로 실제 누락은 26문장 (자동 34건 중 STT 오탐 2·표현만 다름 6). 녹음대로 넣음 — 칸 번호 유지, 27회차 30칸, 음성 37개. 로컬 수정 완료, 배포 대기. 상세 `content-review/listening.md` L-64.
