...
> **정정 (2026-09-17, 수정 단계):** ISS-11·V-01·V-02(VOCA 퀴즈 뜻·누락)는 **감사 오류로 철회** — 실제 코드로 5,831단어 0건 (`issues.md` ISS-11). 재집계 Critical 1 · High 43 · Medium 194 · Low 139. VOCA 레슨 상태 PASS 113 · NOTE 45 · FAIL 37. 아래 본문 수치는 감사 시점 그대로 둠.
