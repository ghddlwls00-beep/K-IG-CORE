...
| R-64 노무현·차베스 지문, R-65 민족별 식사법 지문 | 소유자가 "꼭 바꿔야 하나" 질문 → 문제점 설명함, 답 대기 | 미정 |

## 다음 단계

1. R-64·R-65 소유자 답 받기, L-64 원문 누락 처리 방침
2. 수정 순서 — 최우선 ISS-00 (공개 JS 유출), 이어서 `final-report.md` §20
